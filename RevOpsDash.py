...
with st.expander("Revenue Overview"):
    st.markdown("**Closed Won Revenue by Region**")
    # Aggregate revenue from closed won deals by region
    closed_won_rev = (
    ...
    sns.barplot(x="Region", y="Total_Revenue", data=closed_won_rev, palette="Purples")
    plt.xlabel("Region")
